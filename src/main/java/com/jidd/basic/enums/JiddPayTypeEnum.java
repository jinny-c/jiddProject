...
public enum JiddPayTypeEnum {
	...
	private JiddPayTypeEnum(String type, String desc) {
		this.type = type;
		this.desc = desc;
	}
	...
	public static boolean isQrCodePay(String payType) {
		JiddPayTypeEnum e = covertByType(payType);
	 ...
	 * @return
	 */
	public static JiddPayTypeEnum covertByType(String payType) {
		if (JiddStringUtils.isBlank(payType)) {
			return PAY_TYPE_NONE;
		}
		for (JiddPayTypeEnum e : values()) {
