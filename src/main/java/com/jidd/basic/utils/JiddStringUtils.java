...
public class JiddStringUtils {
	 ...
	 * @return
	 */
	public static String[] splitToArray(String source, JiddSymbolEnum symbol) {
		if (isBlank(source)) {
			return null;
		}
	 ...
	 * 
	 */
	public static String join(JiddSymbolEnum symbol, Object... args) {
		...
		for (Object obj : args) {
			...
			sb.append(obj != null ? obj : JiddSymbolEnum.Blank.symbol());
			count++;
		}
		return sb.toString();
	}
		...
		while (matcher.find()) {
			matcher.appendReplacement(result,
					index < args.length ? (null == args[index] ? "null"
							: args[index]) : JiddSymbolEnum.Blank.symbol());
			index++;
		}
