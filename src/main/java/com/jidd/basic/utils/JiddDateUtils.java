...
public class JiddDateUtils {
	...
	public static String parseToDate(String date) {
		if (JiddStringUtils.isBlank(date)) {
	...
	public static Date parseDate(String pattern, String date) {
		if (JiddStringUtils.isBlank(pattern) || JiddStringUtils.isBlank(date)) {
			return null;
		}
	...
	public static String parseDate(String pattern, Date date) {
		if (null == date || JiddStringUtils.isBlank(pattern)) {
			return null;
		}
		SimpleDateFormat format = new SimpleDateFormat(pattern);
	...
	public static String getCurrentDate(String parrten) {
		if (JiddStringUtils.isBlank(parrten)) {
			return JiddSymbolEnum.Blank.symbol();
		}
	...
	public static Map<String, String> getDateForSet(Integer startMonth,
		...
		if (JiddStringUtils.isBlank(datePattern)) {
	...
	public static String getHpDate(String date) {
		...
		try {
			if (JiddStringUtils.isBlank(date)) {
				result = JiddSymbolEnum.Blank.symbol();
			} else {
			...
			result = date.replace("-", JiddSymbolEnum.Blank.symbol());
		}
		return result;
	}
	...
	public static List<String> getBetweenDates(String beginDate, String endDate) {
		String temp = JiddSymbolEnum.Blank.symbol();
	...
	public static String getNextDay() {
		...
		String nextYear = year - 1 + JiddSymbolEnum.Blank.symbol() + month + JiddSymbolEnum.Blank.symbol() + date + JiddSymbolEnum.Blank.symbol() + hour + JiddSymbolEnum.Blank.symbol()
				+ minute + JiddSymbolEnum.Blank.symbol() + second;
		return nextYear;
	}
	...
	public static String getYearByFormatTime(String time) {
		if (JiddStringUtils.isBlank(time)) {
			return JiddSymbolEnum.Blank.symbol();
		}
		Calendar cal = Calendar.getInstance();
