...
public final class ConfigRef {
	/** microWap.properties*/
	public final static String NO_CARD_PAY_GATEWAY_URL = JiddWapConfigurer.getContextProperty("nocardpay.gateway.url");
	public final static String NO_CARD_PAY_IMAGES_PATH = JiddWapConfigurer.getContextProperty("nocardpay.images.path");
