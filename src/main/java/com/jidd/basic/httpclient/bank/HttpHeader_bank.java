...
public class HttpHeader_bank implements Serializable {
	...
	/** 客户端数据类型 **/
	private JiddSerialTypeEnum dataType;
	...
	public JiddSerialTypeEnum getDataType() {
		return dataType;
	}

	public void setDataType(JiddSerialTypeEnum dataType) {
