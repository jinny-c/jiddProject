...
class JiddHttpPoolConfig {
	 ...
	 * @throws Exception
	 */
	static HttpClientConnectionManager build(JiddHttpParams params,
			SSLConnectionSocketFactory ssf) throws Exception {
		Registry<ConnectionSocketFactory> registry = RegistryBuilder
				.<ConnectionSocketFactory> create()
				.register(JiddHttpConstants.HTTP_PREFIX,
						PlainConnectionSocketFactory.INSTANCE)
				.register(
						JiddHttpConstants.HTTPS_PREFIX,
