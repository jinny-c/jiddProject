package com.jidd.db.common.bean;

public class JiddPage {
	 ...
	 * @param pageSize
	 */
	public JiddPage(int currentPage) {
	 ...
	 * @param orderByClause
	 */
	public JiddPage(int currentPage, String orderByClause) {
		this.current = currentPage == 0 ? 1 : currentPage;
		this.pageSize = 10;
		this.begin = (this.current - 1) * this.pageSize + 1;
		this.end = this.current * this.pageSize;
	 ...
	 * @param pageSize
	 */
	public JiddPage(int currentPage, int pageSize) {
		this.current = currentPage == 0 ? 1 : currentPage;
	...
	public JiddPage(int begin, int pageSize, int count) {
		this(begin, pageSize);
		this.count = count;
	}
