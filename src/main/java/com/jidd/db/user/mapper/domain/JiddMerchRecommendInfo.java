...
public class JiddMerchRecommendInfo {
    ...
    public JiddMerchRecommendInfo(Integer loginUserId, String merchantCode, String recommender, Short recommendType, String recommendPubId, Date createTime, Date uptTime) {
